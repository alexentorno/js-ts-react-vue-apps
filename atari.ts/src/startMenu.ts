export default class StartMenu {
    ...
    constructor(private _appContainer: HTMLDivElement) {
    }
    ...
    drawStartMenu() {
        ...
        function breathe(element: HTMLDivElement) {
            let opacity = 1;
            ...
            function animate() {
                ...
                element.style.opacity = opacity.toString(); // Apply opacity to the element
